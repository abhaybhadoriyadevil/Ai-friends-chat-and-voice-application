...
const UserProfileModal: React.FC<UserProfileModalProps> = ({ isOpen, onClose, userProfile, onUpdateUserProfile, onOpenImagePreview, apiKey, onUpdateApiKey }) => {
    ...
    const getVerificationButtonContent = () => {
    ...
    return (
        ...
        >
            <div
                className="bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md flex flex-col max-h-[90vh] p-6 md:p-8 border border-gray-700"
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    disabled={verificationStatus === 'verifying' || verificationStatus === 'valid'}
                                    className={`px-4 py-2.5 text-sm font-bold text-white rounded-lg transition-colors whitespace-nowrap ${
                                        verificationStatus === 'idle' ? 'bg-indigo-600 hover:bg-indigo-700' : ''
                                    } ${
                                        verificationStatus === 'verifying' ? 'bg-gray-500 cursor-wait' : ''
                                    } ${
                                        verificationStatus === 'valid' ? 'bg-green-600 cursor-default' : ''
                                    } ${
                                        verificationStatus === 'invalid' ? 'bg-red-600' : ''
                                    }`}
                                >
